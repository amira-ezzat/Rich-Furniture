...
import '../../../Drawer_model/outf/out.dart';
import '../furnHome/furniture.dart';
class DataOutHome extends StatefulWidget {
  ...
  @override
  State<DataOutHome> createState() => _DataOutHomeState();
}

class _DataOutHomeState extends State<DataOutHome> {
