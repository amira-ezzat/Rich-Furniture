...
import '../../drawer.dart';
class DataTableTvCatogryProduct extends StatefulWidget {
  final List<Product> products;
  final String title;

  const DataTableTvCatogryProduct({
    super.key,
  ...
  @override
  State<DataTableTvCatogryProduct> createState() => _DataTableTvCatogryProductState();
}

class _DataTableTvCatogryProductState extends State<DataTableTvCatogryProduct> {
              ...
              Padding(
                ...
                child: Wrap(
                  ...
                  children: sortedProducts
                    ...
                    child: ProductTvCard(product: product),
                  ))
                      .toList(),
                ),
              ),
...
class ProductTvCard extends StatelessWidget {
  final Product product;

  const ProductTvCard({super.key, required this.product});
